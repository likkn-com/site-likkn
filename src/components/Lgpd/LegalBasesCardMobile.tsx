...
const LegalBasesCardMobile: React.FC = () => {
        ...
        <Card className={classes.rootBase}>
            ...
            <Collapse in={expanded} timeout="auto" unmountOnExit>
                <CardContent className={classes.cardcontent + " " + classes.cardContentExpanded}>
                    ...
                    {/*<EsferaProcessual /> */}
                    <Card variant="outlined" className={classes.root}>
                        <Typography className={classes.header} > Exercício Regular na Esfera Processual </Typography>
                    ...
                    {/*<ProtecaoVida /> */}
                    <Card variant="outlined" className={classes.root}>
                        <Typography className={classes.header} > Proteção da vida ou incolumidade física </Typography>
                        <div className={classes.image}>
...
export default LegalBasesCardMobile;
